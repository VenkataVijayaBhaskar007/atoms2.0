...
<section className="bg-white dark:bg-gray-900 mt-8">
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <h1 className="max-w-2xl mb-4 text-2xl text-black font-semibold tracking-tight leading-none md:text-2xl xl:text-2xl dark:text-white">Welcome to</h1>
            <h1 className="max-w-2xl mb-4 text-4xl text-blue-600 font-semibold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Engineer's Scoops</h1>
            <p className="max-w-2xl mb-6 font-regular text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Engineer's Scoops is an exceptional ice-cream and falooda outlet proudly brought to you by Atoms Group. With a team of skilled engineers at the helm</p>
...
export default EngineersScoops;
