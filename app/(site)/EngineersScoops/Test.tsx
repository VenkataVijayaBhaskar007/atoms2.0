                ...
                <div className="px-3 md:w-1/3">
                    <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                        ...
                        <div className="w-full">
                            <p className="text-sm leading-tight">Hi bro I’m visit your falooda outlet the falooda is very delicious 🤤 and more to more eat this falooda vans new delicious and new tasty items 😍
Thank you</p>
                        </div>
                    </div>
                    <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                        ...
                        <div className="w-full">
                            <p className="text-sm leading-tight">I think the combination of flavors you chose is absolutely fantastic! It must have been a real treat for taste buds! Keep up the great work in experimenting with different flavors. Me and my friends enjoyed a lot</p>
                        </div>
                    </div>
                </div>
                <div className="px-3 md:w-1/3">
...
Price kuda reasonable ga undi. Finally Aa nuts,aa flavour of icecreams chala bagunnai.All the best bro</p>
                        </div>
                    </div>
                    <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                        <div className="w-full flex mb-4 items-center">
...
E roju Ice cream panipuri tinnamu taste ayithe chala antey chala bagundi ❤we loved it .....</p>
                        </div>
                    </div>
                </div>
                <div className="px-3 md:w-1/3">
